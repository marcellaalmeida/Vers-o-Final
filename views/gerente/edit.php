                ...
                <div class="my-4">
                    ...
                    <form action="update.php" method="post">
                        <p class="form-group">
                            ...
                            <input type="text" name="nivel_acesso" class="form-control" value="<?= $gerente->getNivel_Acesso() ?>">
                        </p>
                        ...
                        <p class="form-group">
                            ...
                            <select name="funcionario" class="form-control">
                                <?php foreach($daoFuncionario->read() as $funcionario) : ?>
                                    <?php if($gerente->getFuncionario()->getId() == $funcionario->getId()) : ?>
