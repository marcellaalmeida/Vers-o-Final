    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="my-4">
                    <h2>Gerente</h2>
                    <a href="create.php">Novo Gerente</a>
                    <table class="table table-hover">
                        ...
                        <?php foreach($dao->read() as $gerente) : ?>
                            <tr>
                                <td><?= $gerente->getId() ?></td>
                                <td><?= $gerente->getNivel_Acesso() ?></td>
                                <td><?= $gerente->getFuncionario() ?></td>
                                <td>
                                    <a href="edit.php?id=<?= $gerente->getId() ?>" title="Editar">
                                        <i class="bi bi-pencil"></i>
                                    </a>
                                    <a class="link link-danger" href="destroy.php?id=<?= $gerente->getId() ?>" title="Excluir">
