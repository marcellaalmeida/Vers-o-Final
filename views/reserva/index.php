    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="my-4">
                    <h2>Reserva</h2>
                    <a href="create.php">Nova Reserva</a>
                    <table class="table table-hover">
                        <tr>
                            ...
                            <th>Tipo de Hospede</th>
                            <th>Tipo de Status_Reserva</th>
                            <th>Ações</th>
                        </tr>
                        <?php foreach($dao->read() as $reserva) : ?>
                            <tr>
                                <td><?= $reserva->getId() ?></td>
                                <td><?= $reserva->getData_Checkin() ?></td>
                                <td><?= $reserva->getData_Checkout() ?></td>
                                <td><?= $reserva->getValor_Total() ?></td>
                                <td><?= $reserva->getFuncionario()->getNome() ?></td>
                                <td><?= $reserva->getHospede()->getNome() ?></td>
                                <td><?= $reserva->getStatus_Reserva()->getDescricao() ?></td>
                                <td>
                                    <a class="link link-success" href="../reservahasquarto/create.php?id=<?= $reserva->getId() ?>" title="Adicionar Quartos">
                                        <i class="bi bi-cart"></i>
                                    </a>
                                    <a href="edit.php?id=<?= $reserva->getId() ?>" title="Editar">
                                        <i class="bi bi-pencil"></i>
                                    </a>
                                    <a class="link link-danger" href="destroy.php?id=<?= $reserva->getId() ?>" title="Excluir">
