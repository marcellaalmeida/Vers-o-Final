                ...
                <div class="my-4">
                    ...
                    <form action="update.php" method="post">
                        <p class="form-group">
                            ...
                            <input type="text" name="numero" class="form-control" value="<?= $quarto->getNumero() ?>">
                        </p>
                        <p class="form-group">
                            <label for="preco_diaria">Preco_Diaria</label>
                            <input type="text" name="preco_diaria" class="form-control" value="<?= $quarto->getPreco_Diaria() ?>">
                        </p>
                        ...
                        <p class="form-group">
                            ...
                            <select name="status" class="form-control">
                                <?php foreach($daoStatus->read() as $status) : ?>
                                    <?php if($quarto->getStatus()->getIdStatus() == $status->getIdStatus()) : ?>
                                        <option selected value="<?= $status->getIdStatus() ?>"><?= $status->getDescricao() ?></option>
                                    <?php else : ?>
                                        <option value="<?= $status->getIdStatus() ?>"><?= $status->getDescricao() ?></option>
                                    <?php endif ?>
                                <?php endforeach ?>
                            </select>
                        </p>
                        <p class="form-group">
                            ...
                            <select name="tipo" class="form-control">
                                <?php foreach($daoTipo->read() as $tipo) : ?>
                                    <?php if($quarto->getTipo()->getIdTipo() == $tipo->getIdTipo()) : ?>
                                        <option selected value="<?= $tipo->getIdTipo() ?>"><?= $tipo->getDescricao() ?></option>
                                    <?php else : ?>
                                        <option value="<?= $tipo->getIdTipo() ?>"><?= $tipo->getDescricao() ?></option>
                                    <?php endif ?>
                                <?php endforeach ?>
                            </select>
                        </p>
                        <input type="hidden" name="id" value="<?= $quarto->getId() ?>">
                        <p class="form-group">
