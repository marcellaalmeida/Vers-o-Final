                ...
                <div class="my-4">
                    ...
                    <form action="insert.php" method="post">
                        <p class="form-group">
                            ...
                            <strong><?= $reserva_id_reserva ?></strong>
                            <input type="hidden" name="reserva_id_reserva" value="<?= $reserva_id_reserva ?>">
                        </p>                        
                        <!-- Para a chave estrangeira (associação com Produto) -->
                        <p class="form-group">
                            <label for="Quarto">Quarto</label>
                            <select name="quarto_idquarto" class="form-control">
                                <?php foreach($daoQuarto->read() as $quarto) : ?>
                                    <option value="<?= $quarto->getId() ?>"><?= $quarto->getNumero() ?></option>
                                <?php endforeach ?>
                            </select>
                        </p>                    
                        <p class="form-group">
